...
source(paste0(path,"/MeanAirTempAirTempRangeASFunction_new.R"))
source(paste0(path,"/HelperFunctionsv1.R"))
source(paste0(path,"/PredictionfunctionsV2.R"))
...
# Data validation and conversion
# 9. Calculation of Lat/Long, and validaton of LAT, LONG (-8, 1.4); Lat (50.8, 52)
...
writeToFile (mainData, path, "/FinalPredictions_GB_data_sprAut_singleYear.csv") 
