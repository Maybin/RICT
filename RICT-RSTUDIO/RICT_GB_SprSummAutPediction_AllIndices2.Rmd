...
path <- "C:/DEFRA/Phase2/RICT" #RICT-GB-SingleYearSummerOnly_RSTUDIO_codes"
#setwd(path)
resultsPath <- "C:/DEFRA/Phase2/AllIndices/Results"
...
#new
AirTempGrid <- readCSVFile(paste0(path, "/AirTempGrid.csv"))
...
#new
NRefg_groups <-  readCSVFile(paste0(path, "/EndGrp_AssessScores.csv"))
...
filepathname <- paste0(path,"/x103EndGroupMeans(FORMATTED)(v.JDB17Dec2019).csv") # x103EndGroupMeans(FORMATTED).csv")
